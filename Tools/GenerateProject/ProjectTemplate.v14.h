...
class TemplateV14 : public Template
{
public:
    TemplateV14(std::string const& gt4RelativePath);
    virtual ~TemplateV14() = default;

private:
    virtual std::string GetMSVSVersion() const { return "v14"; }
